...
let glob_constr_sexpr t = Node (fst @@ M.run @@ SexprMapper.glob_constr_map (mapper tactic_sexpr) t)
let constr_expr_sexpr t = Node (fst @@ M.run @@ SexprMapper.constr_expr_map (mapper tactic_sexpr) t)
