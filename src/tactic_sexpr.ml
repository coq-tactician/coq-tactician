...
let rec glob_constr_sexpr t = Node (fst @@ SexprMapper.glob_constr_map (mapper tactic_sexpr) t)
let rec constr_expr_sexpr t = Node (fst @@ SexprMapper.constr_expr_map (mapper tactic_sexpr) t)
