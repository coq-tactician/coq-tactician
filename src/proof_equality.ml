...
let evars_equal evd1 evd2 (equal : (Evar.t * Evar.t) list) =
  ...
  and eq_evar_info ei1 ei2 =
    ...
    eq_constr_univs_test ~goal_spine:true
      (Namegen.rename_bound_vars_as_displayed env evd1 Names.Id.Set.empty [] ei1.evar_concl)
      (Namegen.rename_bound_vars_as_displayed env evd2 Names.Id.Set.empty [] ei2.evar_concl) &&
